class Exercise {
  constructor(id, name, diff, length, pullUp, pushUp, squats, mile, weight) {
    this.id = id;
    this.name = name;
    this.diff = diff;
    this.length = length;
...
mySelect.onchange = function () {
  let x = function () {
    return document.getElementById("diff").value == "Hard"
      ...
      : document.getElementById("diff").value == "Default"
...
function kerem(value) {
  var successSelect = document.getElementById("success");
  var notyetSelect = document.getElementById("notyet");
  var boxText = document.getElementById("checktext");

  if (value == 1 && successSelect.checked == true) {
    notyetSelect.checked = false;
    console.log("klikk");
    boxText.innerHTML = checkBoxText[0];
    boxText.style.display = "block";
  } else if (value == 2 && notyetSelect.checked == true) {
    successSelect.checked = false;
    console.log("klikk2");
    boxText.innerHTML = checkBoxText[1];
    boxText.style.display = "block";
  } else {
    console.log("semmi");
...
// el.addEventListener("click", kerem, true);

// const el2 = document.getElementById("notyet");
// el2.addEventListener("click", kerem, true);
